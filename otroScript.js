...
document.addEventListener("DOMContentLoaded", function() {
    // Esperar a que se cargue la sección específica
    var seccionEspecifica = document.getElementById("seccion-especifica");
    if (seccionEspecifica) {
        // Ejecutar el código del segundo script después de la sección específica
        // Coloca aquí el código del segundo script
        console.log("El segundo script se ejecutará después de la sección específica.");
    }
});
